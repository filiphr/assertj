...
public abstract class AbstractBigDecimalAssert<SELF extends AbstractBigDecimalAssert<SELF>> extends
  ...
  @Override
  public SELF isZero() {
    return runSoftly(() -> bigDecimals.assertIsZero(info, actual));
  }
  ...
  public SELF isNotZero() {
    return runSoftly(() -> bigDecimals.assertIsNotZero(info, actual));
  }
  ...
  @Override
  public SELF isOne() {
    return runSoftly(() -> bigDecimals.assertIsOne(info, actual));
  }
  ...
  public SELF isPositive() {
    return runSoftly(() -> bigDecimals.assertIsPositive(info, actual));
  }
  ...
  public SELF isNegative() {
    return runSoftly(() -> bigDecimals.assertIsNegative(info, actual));
  }
  ...
  public SELF isNotPositive() {
    return runSoftly(() -> bigDecimals.assertIsNotPositive(info, actual));
  }
  ...
  public SELF isNotNegative() {
    return runSoftly(() -> bigDecimals.assertIsNotNegative(info, actual));
  }
  ...
  public SELF isBetween(BigDecimal start, BigDecimal end) {
    return runSoftly(() -> bigDecimals.assertIsBetween(info, actual, start, end));
  }
  ...
  public SELF isStrictlyBetween(BigDecimal start, BigDecimal end) {
    return runSoftly(() -> bigDecimals.assertIsStrictlyBetween(info, actual, start, end));
  }
  ...
  public SELF hasScaleOf(int expectedScale) {
    return runSoftly(() -> bigDecimals.assertHasScale(info, actual, expectedScale));
  }
  ...
  public SELF isCloseTo(final BigDecimal expected, final Offset<BigDecimal> offset) {
    return runSoftly(() -> bigDecimals.assertIsCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isNotCloseTo(final BigDecimal expected, final Offset<BigDecimal> offset) {
    return runSoftly(() -> bigDecimals.assertIsNotCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isCloseTo(BigDecimal expected, Percentage percentage) {
    return runSoftly(() -> bigDecimals.assertIsCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public SELF isNotCloseTo(BigDecimal expected, Percentage percentage) {
    return runSoftly(() -> bigDecimals.assertIsNotCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public AbstractBigDecimalScaleAssert<SELF> scale() {
    ...
    BigDecimalScaleAssert result = new BigDecimalScaleAssert(myself);
