...
public abstract class AbstractBooleanArrayAssert<SELF extends AbstractBooleanArrayAssert<SELF>>
  ...
  public SELF contains(Boolean[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF containsOnly(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF containsSequence(Boolean[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveBooleanArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Boolean[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveBooleanArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF startsWith(Boolean[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveBooleanArray(sequence)));
  }
  ...
  public SELF endsWith(Boolean[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveBooleanArray(sequence)));
  }
  ...
  public SELF containsExactly(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveBooleanArray(values)));
  }
  ...
  public SELF containsAnyOf(Boolean[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveBooleanArray(values)));
  }
