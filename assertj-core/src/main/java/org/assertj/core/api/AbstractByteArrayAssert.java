...
public abstract class AbstractByteArrayAssert<SELF extends AbstractByteArrayAssert<SELF>>
  ...
  public SELF contains(Byte[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsOnly(Byte[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Byte[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsSequence(Byte[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveByteArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Byte[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveByteArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Byte[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF startsWith(Byte[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveByteArray(sequence)));
  }
  ...
  public SELF endsWith(Byte[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveByteArray(sequence)));
  }
  ...
  public SELF containsExactly(byte... values) {
    ...
    return runSoftly(() -> objects.assertEqual(info, actual, values));
  }
  ...
  public SELF containsExactly(Byte[] values) {
    ...
    requireNonNullParameter(values, "values");
    return runSoftly(() -> objects.assertEqual(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsExactly(int... values) {
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, arrays.toByteArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Byte[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(int... values) {
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, arrays.toByteArray(values)));
  }
  ...
  public SELF containsAnyOf(Byte[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveByteArray(values)));
  }
  ...
  public SELF containsAnyOf(int... values) {
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, arrays.toByteArray(values)));
  }
