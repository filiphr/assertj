...
public abstract class AbstractCharArrayAssert<SELF extends AbstractCharArrayAssert<SELF>>
  ...
  public SELF contains(Character[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF containsOnly(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF containsSequence(Character[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveCharacterArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Character[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveCharacterArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF startsWith(Character[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveCharacterArray(sequence)));
  }
  ...
  public SELF endsWith(Character[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveCharacterArray(sequence)));
  }
  ...
  public SELF containsExactly(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveCharacterArray(values)));
  }
  ...
  public SELF containsAnyOf(Character[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveCharacterArray(values)));
  }
