...
public abstract class AbstractCharSequenceAssert<SELF extends AbstractCharSequenceAssert<SELF, ACTUAL>, ACTUAL extends CharSequence>
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> strings.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> strings.assertEmpty(info, actual));
  }
  ...
  public SELF isNotEmpty() {
    return runSoftly(() -> strings.assertNotEmpty(info, actual));
  }
  ...
  public SELF isNotBlank() {
    return runSoftly(() -> assertNotBlank());
  }
  ...
  public SELF containsWhitespaces() {
    return runSoftly(() -> assertContainsWhitespaces());
  }
  ...
  public SELF containsOnlyWhitespaces() {
    return runSoftly(() -> assertContainsOnlyWhitespaces());
  }
  ...
  public SELF doesNotContainAnyWhitespaces() {
    return runSoftly(() -> assertDoesNotContainAnyWhitespaces());
  }
  ...
  public SELF doesNotContainOnlyWhitespaces() {
    return runSoftly(() -> assertDoesNotContainOnlyWhitespaces());
  }
  ...
  public SELF hasSize(int expected) {
    return runSoftly(() -> strings.assertHasSize(info, actual, expected));
  }
  ...
  public SELF hasSizeLessThan(int expected) {
    return runSoftly(() -> strings.assertHasSizeLessThan(info, actual, expected));
  }
  ...
  public SELF hasSizeLessThanOrEqualTo(int expected) {
    return runSoftly(() -> strings.assertHasSizeLessThanOrEqualTo(info, actual, expected));
  }
  ...
  public SELF hasSizeGreaterThan(int expected) {
    return runSoftly(() -> strings.assertHasSizeGreaterThan(info, actual, expected));
  }
  ...
  public SELF hasSizeGreaterThanOrEqualTo(int expected) {
    return runSoftly(() -> strings.assertHasSizeGreaterThanOrEqualTo(info, actual, expected));
  }
  ...
  public SELF hasSizeBetween(int lowerBoundary, int higherBoundary) {
    return runSoftly(() -> strings.assertHasSizeBetween(info, actual, lowerBoundary, higherBoundary));
  }
   ...
   * or a carriage return followed immediately by a linefeed (see {@link java.io.LineNumberReader}).
   * <p>
   * This assertion succeeds:
  ...
  public SELF hasLineCount(int expectedLineCount) {
    return runSoftly(() -> strings.assertHasLineCount(info, actual, expectedLineCount));
  }
  ...
  public SELF hasSameSizeAs(CharSequence other) {
    return runSoftly(() -> strings.assertHasSameSizeAs(info, actual, other));
  }
  ...
  public SELF isEqualToIgnoringCase(CharSequence expected) {
    return runSoftly(() -> strings.assertEqualsIgnoringCase(info, actual, expected));
  }
  ...
  public SELF isNotEqualToIgnoringCase(CharSequence expected) {
    return runSoftly(() -> strings.assertNotEqualsIgnoringCase(info, actual, expected));
  }
  ...
  public SELF containsOnlyDigits() {
    return runSoftly(() -> strings.assertContainsOnlyDigits(info, actual));
  }
  ...
  public SELF containsOnlyOnce(CharSequence sequence) {
    return runSoftly(() -> strings.assertContainsOnlyOnce(info, actual, sequence));
  }
  ...
  public SELF contains(CharSequence... values) {
    return runSoftly(() -> strings.assertContains(info, actual, values));
  }
  ...
  public SELF containsAnyOf(CharSequence... values) {
    return runSoftly(() -> strings.assertContainsAnyOf(info, actual, values));
  }
  ...
  public SELF contains(Iterable<? extends CharSequence> values) {
    return runSoftly(() -> strings.assertContains(info, actual, toArray(values, CharSequence.class)));
  }
  ...
  public SELF containsSequence(CharSequence... values) {
    return runSoftly(() -> strings.assertContainsSequence(info, actual, values));
  }
  ...
  public SELF containsSequence(Iterable<? extends CharSequence> values) {
    return runSoftly(() -> strings.assertContainsSequence(info, actual, toArray(values, CharSequence.class)));
  }
  ...
  public SELF containsSubsequence(CharSequence... values) {
    return runSoftly(() -> strings.assertContainsSubsequence(info, actual, values));
  }
  ...
  public SELF containsSubsequence(Iterable<? extends CharSequence> values) {
    return runSoftly(() -> strings.assertContainsSubsequence(info, actual, toArray(values, CharSequence.class)));
  }
  ...
  public SELF containsIgnoringCase(CharSequence sequence) {
    return runSoftly(() -> strings.assertContainsIgnoringCase(info, actual, sequence));
  }
  ...
  public SELF containsIgnoringWhitespaces(CharSequence... values) {
    return runSoftly(() -> assertContainsIgnoringWhitespaces(values));
  }
  ...
  public SELF containsIgnoringNewlines(final CharSequence... values) {
    return runSoftly(() -> strings.assertContainsIgnoringNewlines(info, actual, values));
  }
  ...
  public SELF doesNotContain(CharSequence... values) {
    return runSoftly(() -> strings.assertDoesNotContain(info, actual, values));
  }
  ...
  public SELF doesNotContain(Iterable<? extends CharSequence> values) {
    return runSoftly(() -> strings.assertDoesNotContain(info, actual, toArray(values, CharSequence.class)));
  }
  ...
  public SELF doesNotContainSequence(CharSequence... sequence) {
    return runSoftly(() -> strings.assertDoesNotContainSequence(info, actual, sequence));
  }
  ...
  public SELF doesNotContainSequence(Iterable<? extends CharSequence> sequence) {
    return runSoftly(() -> strings.assertDoesNotContainSequence(info, actual, toArray(sequence, CharSequence.class)));
  }
  ...
  public SELF doesNotContainSubsequence(CharSequence... subsequence) {
    return runSoftly(() -> strings.assertDoesNotContainSubsequence(info, actual, subsequence));
  }
  ...
  public SELF doesNotContainSubsequence(Iterable<? extends CharSequence> subsequence) {
    return runSoftly(() -> strings.assertDoesNotContainSubsequence(info, actual, toArray(subsequence, CharSequence.class)));
  }
  ...
  public SELF doesNotContainIgnoringCase(CharSequence... values) {
    return runSoftly(() -> strings.assertDoesNotContainIgnoringCase(info, actual, values));
  }
  ...
  public SELF doesNotContainPattern(CharSequence pattern) {
    return runSoftly(() -> strings.assertDoesNotContainPattern(info, actual, pattern));
  }
  ...
  public SELF startsWith(CharSequence prefix) {
    return runSoftly(() -> strings.assertStartsWith(info, actual, prefix));
  }
  ...
  public SELF startsWithIgnoringCase(CharSequence prefix) {
    return runSoftly(() -> strings.assertStartsWithIgnoringCase(info, actual, prefix));
  }
  ...
  public SELF doesNotStartWith(CharSequence prefix) {
    return runSoftly(() -> strings.assertDoesNotStartWith(info, actual, prefix));
  }
  ...
  public SELF doesNotStartWithIgnoringCase(CharSequence prefix) {
    return runSoftly(() -> strings.assertDoesNotStartWithIgnoringCase(info, actual, prefix));
  }
  ...
  public SELF endsWith(CharSequence suffix) {
    return runSoftly(() -> strings.assertEndsWith(info, actual, suffix));
  }
  ...
  public SELF endsWithIgnoringCase(CharSequence suffix) {
    return runSoftly(() -> strings.assertEndsWithIgnoringCase(info, actual, suffix));
  }
  ...
  public SELF doesNotEndWith(CharSequence suffix) {
    return runSoftly(() -> strings.assertDoesNotEndWith(info, actual, suffix));
  }
  ...
  public SELF doesNotEndWithIgnoringCase(CharSequence suffix) {
    return runSoftly(() -> strings.assertDoesNotEndWithIgnoringCase(info, actual, suffix));
  }
  ...
  public SELF matches(CharSequence regex) {
    return runSoftly(() -> strings.assertMatches(info, actual, regex));
  }
  ...
  public SELF doesNotMatch(CharSequence regex) {
    return runSoftly(() -> strings.assertDoesNotMatch(info, actual, regex));
  }
  ...
  public SELF matches(Pattern pattern) {
    return runSoftly(() -> strings.assertMatches(info, actual, pattern));
  }
  ...
  public SELF doesNotMatch(Pattern pattern) {
    return runSoftly(() -> strings.assertDoesNotMatch(info, actual, pattern));
  }
  ...
  public SELF isEqualToIgnoringWhitespace(CharSequence expected) {
    return runSoftly(() -> strings.assertEqualsIgnoringWhitespace(info, actual, expected));
  }
  ...
  public SELF isNotEqualToIgnoringWhitespace(CharSequence expected) {
    return runSoftly(() -> strings.assertNotEqualsIgnoringWhitespace(info, actual, expected));
  }
  ...
  public SELF isEqualToNormalizingWhitespace(CharSequence expected) {
    return runSoftly(() -> strings.assertEqualsNormalizingWhitespace(info, actual, expected));
  }
  ...
  public SELF isNotEqualToNormalizingWhitespace(CharSequence expected) {
    return runSoftly(() -> strings.assertNotEqualsNormalizingWhitespace(info, actual, expected));
  }
  ...
  public SELF isEqualToNormalizingPunctuationAndWhitespace(CharSequence expected) {
    return runSoftly(() -> strings.assertEqualsNormalizingPunctuationAndWhitespace(info, actual, expected));
  }
  ...
  public SELF isSubstringOf(CharSequence sequence) {
    return runSoftly(() -> strings.assertIsSubstringOf(info, actual, sequence));
  }
  ...
  public SELF containsPattern(CharSequence regex) {
    return runSoftly(() -> strings.assertContainsPattern(info, actual, regex));
  }
  ...
  public SELF containsPattern(Pattern pattern) {
    return runSoftly(() -> strings.assertContainsPattern(info, actual, pattern));
  }
  ...
  public SELF isEqualToNormalizingNewlines(CharSequence expected) {
    return runSoftly(() -> strings.assertIsEqualToNormalizingNewlines(info, actual, expected));
  }
  ...
  public SELF isEqualToIgnoringNewlines(CharSequence expected) {
    return runSoftly(() -> strings.assertIsEqualToIgnoringNewlines(info, actual, expected));
  }
  ...
  public SELF isLowerCase() {
    return runSoftly(() -> strings.assertLowerCase(info, actual));
  }
  ...
  public SELF isMixedCase() {
    return runSoftly(() -> strings.assertMixedCase(info, actual));
  }
  ...
  public SELF isUpperCase() {
    return runSoftly(() -> strings.assertUpperCase(info, actual));
  }

  /**
   * Verifies that the actual {@code CharSequence} is equal to the given one after they have been normalized
   * according to the {@link java.text.Normalizer.Form#NFC} form, which is a canonical decomposition followed by canonical composition.
   * <p>
   * Example:
   * <pre><code class='java'> // assertions succeed:
   *
   ...
   * @return {@code this} assertion object.
   * @throws AssertionError       if the actual {@code CharSequence} is not equal to the given one
   *                              after both strings have been normalized to according to the {@link java.text.Normalizer.Form#NFC} form .
  ...
  public SELF isEqualToNormalizingUnicode(CharSequence expected) {
    return runSoftly(() -> strings.assertEqualsToNormalizingUnicode(info, actual, expected));
  }
