...
public abstract class AbstractCharacterAssert<SELF extends AbstractCharacterAssert<SELF>> extends
  ...
  public SELF isEqualTo(char expected) {
    return runSoftly(() -> characters.assertEqual(info, actual, expected));
  }
  ...
  public SELF isNotEqualTo(char other) {
    return runSoftly(() -> characters.assertNotEqual(info, actual, other));
  }
  ...
  public SELF isLessThan(char other) {
    return runSoftly(() -> characters.assertLessThan(info, actual, other));
  }
  ...
  public SELF isLessThanOrEqualTo(char other) {
    return runSoftly(() -> characters.assertLessThanOrEqualTo(info, actual, other));
  }
  ...
  public SELF isGreaterThan(char other) {
    return runSoftly(() -> characters.assertGreaterThan(info, actual, other));
  }
  ...
  public SELF isGreaterThanOrEqualTo(char other) {
    return runSoftly(() -> characters.assertGreaterThanOrEqualTo(info, actual, other));
  }
  ...
  public SELF isLowerCase() {
    return runSoftly(() -> characters.assertLowerCase(info, actual));
  }
  ...
  public SELF isUpperCase() {
    return runSoftly(() -> characters.assertUpperCase(info, actual));
  }
