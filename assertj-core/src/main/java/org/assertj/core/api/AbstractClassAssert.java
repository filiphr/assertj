...
public abstract class AbstractClassAssert<SELF extends AbstractClassAssert<SELF>>
  ...
  public SELF isAssignableFrom(Class<?>... others) {
    return runSoftly(() -> classes.assertIsAssignableFrom(info, actual, others));
  }
  ...
  public SELF hasPublicFields(String... fields) {
    return runSoftly(() -> classes.assertHasPublicFields(info, actual, fields));
  }
  ...
  public SELF hasOnlyPublicFields(String... fields) {
    return runSoftly(() -> classes.assertHasOnlyPublicFields(info, actual, fields));
  }
  ...
  public SELF hasDeclaredFields(String... fields) {
    return runSoftly(() -> classes.assertHasDeclaredFields(info, actual, fields));
  }
  ...
  public SELF hasOnlyDeclaredFields(String... fields) {
    return runSoftly(() -> classes.assertHasOnlyDeclaredFields(info, actual, fields));
  }
  ...
  public SELF hasMethods(String... methodNames) {
    return runSoftly(() -> classes.assertHasMethods(info, actual, methodNames));
  }
  ...
  public SELF hasDeclaredMethods(String... methodNames) {
    return runSoftly(() -> classes.assertHasDeclaredMethods(info, actual, methodNames));
  }
  ...
  public SELF hasPublicMethods(String... methodNames) {
    return runSoftly(() -> classes.assertHasPublicMethods(info, actual, methodNames));
  }
