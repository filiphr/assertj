...
public abstract class AbstractDateAssert<SELF extends AbstractDateAssert<SELF>> extends AbstractAssertWithComparator<SELF, Date> {
  ...
  public SELF isBefore(Date other) {
    return runSoftly(() -> dates.assertIsBefore(info, actual, other));
  }
  ...
  public SELF isBefore(Instant other) {
    return runSoftly(() -> dates.assertIsBefore(info, actual, dateFrom(other)));
  }
  ...
  public SELF isBeforeOrEqualTo(Date other) {
    return runSoftly(() -> dates.assertIsBeforeOrEqualTo(info, actual, other));
  }
  ...
  public SELF isBeforeOrEqualTo(Instant other) {
    return runSoftly(() -> dates.assertIsBeforeOrEqualTo(info, actual, dateFrom(other)));
  }
  ...
  public SELF isAfter(Date other) {
    return runSoftly(() -> dates.assertIsAfter(info, actual, other));
  }
  ...
  public SELF isAfter(Instant other) {
    return runSoftly(() -> dates.assertIsAfter(info, actual, dateFrom(other)));
  }
  ...
  public SELF isAfterOrEqualTo(Date other) {
    return runSoftly(() -> dates.assertIsAfterOrEqualTo(info, actual, other));
  }
  ...
  public SELF isAfterOrEqualTo(Instant other) {
    return runSoftly(() -> dates.assertIsAfterOrEqualTo(info, actual, dateFrom(other)));
  }
  ...
  public SELF isBetween(Date start, Date end, boolean inclusiveStart, boolean inclusiveEnd) {
    return runSoftly(() -> dates.assertIsBetween(info, actual, start, end, inclusiveStart, inclusiveEnd));
  }
  ...
  public SELF isBetween(String start, String end, boolean inclusiveStart, boolean inclusiveEnd) {
    return runSoftly(() -> dates.assertIsBetween(info, actual, parse(start), parse(end), inclusiveStart, inclusiveEnd));
  }
  ...
  public SELF isBetween(Instant start, Instant end, boolean inclusiveStart, boolean inclusiveEnd) {
    return runSoftly(() -> dates.assertIsBetween(info, actual, dateFrom(start), dateFrom(end), inclusiveStart, inclusiveEnd));
  }
  ...
  public SELF isNotBetween(Date start, Date end, boolean inclusiveStart, boolean inclusiveEnd) {
    return runSoftly(() -> dates.assertIsNotBetween(info, actual, start, end, inclusiveStart, inclusiveEnd));
  }
  ...
  public SELF isNotBetween(Instant start, Instant end, boolean inclusiveStart, boolean inclusiveEnd) {
    return runSoftly(() -> dates.assertIsNotBetween(info, actual, dateFrom(start), dateFrom(end), inclusiveStart, inclusiveEnd));
  }
  ...
  public SELF isInThePast() {
    return runSoftly(() -> dates.assertIsInThePast(info, actual));
  }
   ...
   */
  public SELF isToday() {
    return runSoftly(() -> dates.assertIsToday(info, actual));
  }
  ...
  public SELF isInTheFuture() {
    return runSoftly(() -> dates.assertIsInTheFuture(info, actual));
  }
  ...
  public SELF isBeforeYear(int year) {
    return runSoftly(() -> dates.assertIsBeforeYear(info, actual, year));
  }
  ...
  public SELF isAfterYear(int year) {
    return runSoftly(() -> dates.assertIsAfterYear(info, actual, year));
  }
  ...
  public SELF hasYear(int year) {
    return runSoftly(() -> dates.assertHasYear(info, actual, year));
  }
  ...
  public SELF hasMonth(int month) {
    return runSoftly(() -> dates.assertHasMonth(info, actual, month));
  }
  ...
  public SELF hasDayOfMonth(int dayOfMonth) {
    return runSoftly(() -> dates.assertHasDayOfMonth(info, actual, dayOfMonth));
  }
  ...
  public SELF hasDayOfWeek(int dayOfWeek) {
    return runSoftly(() -> dates.assertHasDayOfWeek(info, actual, dayOfWeek));
  }
  ...
  public SELF hasHourOfDay(int hourOfDay) {
    return runSoftly(() -> dates.assertHasHourOfDay(info, actual, hourOfDay));
  }
  ...
  public SELF hasMinute(int minute) {
    return runSoftly(() -> dates.assertHasMinute(info, actual, minute));
  }
  ...
  public SELF hasSecond(int second) {
    return runSoftly(() -> dates.assertHasSecond(info, actual, second));
  }
  ...
  public SELF hasMillisecond(int millisecond) {
    return runSoftly(() -> dates.assertHasMillisecond(info, actual, millisecond));
  }
  ...
  public SELF isInSameYearAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameYearAs(info, actual, other));
  }
  ...
  public SELF isInSameYearAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameYearAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isInSameMonthAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameMonthAs(info, actual, other));
  }
  ...
  public SELF isInSameMonthAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameMonthAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isInSameDayAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameDayAs(info, actual, other));
  }
  ...
  public SELF isInSameDayAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameDayAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isInSameHourWindowAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameHourWindowAs(info, actual, other));
  }
  ...
  public SELF isInSameHourWindowAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameHourWindowAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isInSameMinuteWindowAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameMinuteWindowAs(info, actual, other));
  }
  ...
  public SELF isInSameMinuteWindowAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameMinuteWindowAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isInSameSecondWindowAs(Date other) {
    return runSoftly(() -> dates.assertIsInSameSecondWindowAs(info, actual, other));
  }
  ...
  public SELF isInSameSecondWindowAs(Instant other) {
    return runSoftly(() -> dates.assertIsInSameSecondWindowAs(info, actual, dateFrom(other)));
  }
  ...
  public SELF isCloseTo(Date other, long deltaInMilliseconds) {
    return runSoftly(() -> dates.assertIsCloseTo(info, actual, other, deltaInMilliseconds));
  }
  ...
  public SELF isCloseTo(Instant other, long deltaInMilliseconds) {
    return runSoftly(() -> dates.assertIsCloseTo(info, actual, dateFrom(other), deltaInMilliseconds));
  }
  ...
  public SELF hasTime(long timestamp) {
    return runSoftly(() -> dates.assertHasTime(info, actual, timestamp));
  }
  ...
  public SELF hasSameTimeAs(Date date) {
    return runSoftly(() -> dates.hasSameTimeAs(info, actual, date));
  }
  ...
  public SELF hasSameTimeAs(String dateAsString) {
    return runSoftly(() -> dates.hasSameTimeAs(info, actual, parse(dateAsString)));
  }
