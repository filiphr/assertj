...
public abstract class AbstractDoubleAssert<SELF extends AbstractDoubleAssert<SELF>> extends
  ...
  @Override
  public SELF isNaN() {
    return runSoftly(() -> doubles.assertIsNaN(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotNaN() {
    return runSoftly(() -> doubles.assertIsNotNaN(info, actual));
  }
  ...
  @Override
  public SELF isOne() {
    return runSoftly(() -> doubles.assertIsOne(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isPositive() {
    return runSoftly(() -> doubles.assertIsPositive(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNegative() {
    return runSoftly(() -> doubles.assertIsNegative(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotNegative() {
    return runSoftly(() -> doubles.assertIsNotNegative(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotPositive() {
    return runSoftly(() -> doubles.assertIsNotPositive(info, actual));
  }
  ...
  public SELF isCloseTo(final double expected, final Offset<Double> offset) {
    return runSoftly(() -> doubles.assertIsCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isNotCloseTo(final double expected, final Offset<Double> offset) {
    return runSoftly(() -> doubles.assertIsNotCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isCloseTo(Double expected, Percentage percentage) {
    return runSoftly(() -> doubles.assertIsCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public SELF isNotCloseTo(Double expected, Percentage percentage) {
    return runSoftly(() -> doubles.assertIsNotCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public SELF isLessThan(double other) {
    return runSoftly(() -> doubles.assertLessThan(info, actual, other));
  }
  ...
  public SELF isGreaterThan(double other) {
    return runSoftly(() -> doubles.assertGreaterThan(info, actual, other));
  }
  ...
  public SELF isBetween(Double start, Double end) {
    return runSoftly(() -> doubles.assertIsBetween(info, actual, start, end));
  }
  ...
  public SELF isStrictlyBetween(Double start, Double end) {
    return runSoftly(() -> doubles.assertIsStrictlyBetween(info, actual, start, end));
  }
  ...
  public SELF isFinite() {
    return runSoftly(() -> doubles.assertIsFinite(info, actual));
  }

  /**
   * Verifies that the double value is not a finite floating-point value.
   * <p>
   * Note that 'not finite' is not equivalent to infinite as `NaN` is neither finite nor infinite.
   * <p>
   * Example:
   * <pre><code class='java'> // assertions succeed:
  ...
  public SELF isNotFinite() {
    return runSoftly(() -> doubles.assertIsNotFinite(info, actual));
  }
  ...
  public SELF isInfinite() {
    return runSoftly(() -> doubles.assertIsInfinite(info, actual));
  }
  ...
  public SELF isNotInfinite() {
    return runSoftly(() -> doubles.assertIsNotInfinite(info, actual));
  }
}
