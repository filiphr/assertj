...
public abstract class AbstractFileAssert<SELF extends AbstractFileAssert<SELF>> extends AbstractAssertWithComparator<SELF, File> {
   ...
   */
  public SELF exists() {
    return runSoftly(() -> files.assertExists(info, actual));
  }
  ...
  public SELF doesNotExist() {
    return runSoftly(() -> files.assertDoesNotExist(info, actual));
  }
   ...
   */
  public SELF isFile() {
    return runSoftly(() -> files.assertIsFile(info, actual));
  }
  ...
  public SELF isDirectory() {
    return runSoftly(() -> files.assertIsDirectory(info, actual));
  }
  ...
  public SELF isAbsolute() {
    return runSoftly(() -> files.assertIsAbsolute(info, actual));
  }
  ...
  public SELF isRelative() {
    return runSoftly(() -> files.assertIsRelative(info, actual));
  }
  ...
  public SELF isExecutable() {
    return runSoftly(() -> files.assertIsExecutable(info, actual));
  }
  ...
  public SELF hasSameTextualContentAs(File expected) {
    return runSoftly(() -> files.assertSameContentAs(info, actual, charset, expected, Charset.defaultCharset()));
  }
  ...
  public SELF hasSameBinaryContentAs(File expected) {
    return runSoftly(() -> files.assertSameBinaryContentAs(info, actual, expected));
  }
  ...
  public SELF hasSameTextualContentAs(File expected, Charset expectedCharset) {
    return runSoftly(() -> files.assertSameContentAs(info, actual, charset, expected, expectedCharset));
  }
  ...
  public SELF hasBinaryContent(byte[] expected) {
    return runSoftly(() -> files.assertHasBinaryContent(info, actual, expected));
  }
  ...
  public SELF hasSize(long expectedSizeInBytes) {
    return runSoftly(() -> files.assertHasSizeInBytes(info, actual, expectedSizeInBytes));
  }
  ...
  public SELF hasContent(String expected) {
    return runSoftly(() -> files.assertHasContent(info, actual, expected, charset));
  }
  ...
  public SELF canWrite() {
    return runSoftly(() -> files.assertCanWrite(info, actual));
  }
   ...
   */
  public SELF canRead() {
    return runSoftly(() -> files.assertCanRead(info, actual));
  }
  ...
  public SELF hasParent(File expected) {
    return runSoftly(() -> files.assertHasParent(info, actual, expected));
  }
  ...
  public SELF hasParent(String expected) {
    return runSoftly(() -> files.assertHasParent(info, actual, expected != null ? new File(expected) : null));
  }
  ...
  public SELF hasExtension(String expected) {
    return runSoftly(() -> files.assertHasExtension(info, actual, expected));
  }
  ...
  public SELF hasName(String expected) {
    return runSoftly(() -> files.assertHasName(info, actual, expected));
  }
  ...
  public SELF hasNoParent() {
    return runSoftly(() -> files.assertHasNoParent(info, actual));
  }
  ...
  public SELF hasDigest(MessageDigest digest, byte[] expected) {
    return runSoftly(() -> files.assertHasDigest(info, actual, digest, expected));
  }
  ...
  public SELF hasDigest(String algorithm, byte[] expected) {
    return runSoftly(() -> files.assertHasDigest(info, actual, algorithm, expected));
  }
  ...
  public SELF isDirectoryContaining(Predicate<File> filter) {
    return runSoftly(() -> files.assertIsDirectoryContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryContaining(String syntaxAndPattern) {
    return runSoftly(() -> files.assertIsDirectoryContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isDirectoryRecursivelyContaining(String syntaxAndPattern) {
    return runSoftly(() -> files.assertIsDirectoryRecursivelyContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isDirectoryRecursivelyContaining(Predicate<File> filter) {
    return runSoftly(() -> files.assertIsDirectoryRecursivelyContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryNotContaining(Predicate<File> filter) {
    return runSoftly(() -> files.assertIsDirectoryNotContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryNotContaining(String syntaxAndPattern) {
    return runSoftly(() -> files.assertIsDirectoryNotContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isEmptyDirectory() {
    return runSoftly(() -> files.assertIsEmptyDirectory(info, actual));
  }
  ...
  public SELF isNotEmptyDirectory() {
    return runSoftly(() -> files.assertIsNotEmptyDirectory(info, actual));
  }
   ...
   */
  public SELF isEmpty() {
    return runSoftly(() -> files.assertIsEmptyFile(info, actual));
  }
  ...
  public SELF isNotEmpty() {
    return runSoftly(() -> files.assertIsNotEmptyFile(info, actual));
  }
  ...
  public SELF hasNoExtension() {
    return runSoftly(() -> files.assertHasNoExtension(info, actual));
  }
