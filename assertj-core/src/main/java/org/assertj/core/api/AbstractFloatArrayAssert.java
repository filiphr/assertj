...
public abstract class AbstractFloatArrayAssert<SELF extends AbstractFloatArrayAssert<SELF>>
  ...
  public SELF contains(Float[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  public SELF containsOnly(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  */
  ...
  public SELF containsSequence(Float[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveFloatArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Float[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveFloatArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  public SELF startsWith(Float[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveFloatArray(sequence)));
  }
  ...
  public SELF endsWith(Float[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveFloatArray(sequence)));
  }
  ...
  public SELF containsExactly(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveFloatArray(values)));
  }
  ...
  public SELF containsAnyOf(Float[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveFloatArray(values)));
  }
