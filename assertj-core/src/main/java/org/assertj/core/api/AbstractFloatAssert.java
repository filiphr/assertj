...
public abstract class AbstractFloatAssert<SELF extends AbstractFloatAssert<SELF>> extends AbstractComparableAssert<SELF, Float>
  ...
  @Override
  public SELF isNaN() {
    return runSoftly(() -> floats.assertIsNaN(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotNaN() {
    return runSoftly(() -> floats.assertIsNotNaN(info, actual));
  }
  ...
  @Override
  public SELF isOne() {
    return runSoftly(() -> floats.assertIsOne(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isPositive() {
    return runSoftly(() -> floats.assertIsPositive(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNegative() {
    return runSoftly(() -> floats.assertIsNegative(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotNegative() {
    return runSoftly(() -> floats.assertIsNotNegative(info, actual));
  }

  /** {@inheritDoc} */
  @Override
  public SELF isNotPositive() {
    return runSoftly(() -> floats.assertIsNotPositive(info, actual));
  }
  ...
  public SELF isCloseTo(final float expected, final Offset<Float> offset) {
    return runSoftly(() -> floats.assertIsCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isNotCloseTo(final float expected, final Offset<Float> offset) {
    return runSoftly(() -> floats.assertIsNotCloseTo(info, actual, expected, offset));
  }
  ...
  public SELF isCloseTo(Float expected, Percentage percentage) {
    return runSoftly(() -> floats.assertIsCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public SELF isNotCloseTo(Float expected, Percentage percentage) {
    return runSoftly(() -> floats.assertIsNotCloseToPercentage(info, actual, expected, percentage));
  }
  ...
  public SELF isLessThan(float other) {
    return runSoftly(() -> floats.assertLessThan(info, actual, other));
  }
  ...
  public SELF isGreaterThan(float other) {
    return runSoftly(() -> floats.assertGreaterThan(info, actual, other));
  }
  ...
  public SELF isBetween(Float start, Float end) {
    return runSoftly(() -> floats.assertIsBetween(info, actual, start, end));
  }
  ...
  public SELF isStrictlyBetween(Float start, Float end) {
    return runSoftly(() -> floats.assertIsStrictlyBetween(info, actual, start, end));
  }
  ...
  public SELF isFinite() {
    return runSoftly(() -> floats.assertIsFinite(info, actual));
  }
  ...
  public SELF isNotFinite() {
    return runSoftly(() -> floats.assertIsNotFinite(info, actual));
  }
  ...
  public SELF isInfinite() {
    return runSoftly(() -> floats.assertIsInfinite(info, actual));
  }
  ...
  public SELF isNotInfinite() {
    return runSoftly(() -> floats.assertIsNotInfinite(info, actual));
  }
}
