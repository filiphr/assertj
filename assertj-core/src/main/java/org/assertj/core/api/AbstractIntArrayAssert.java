...
public abstract class AbstractIntArrayAssert<SELF extends AbstractIntArrayAssert<SELF>>
  ...
  public SELF contains(Integer[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF containsOnly(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF containsSequence(Integer[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveIntArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Integer[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveIntArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF startsWith(Integer[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveIntArray(sequence)));
  }
  ...
  public SELF endsWith(Integer[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveIntArray(sequence)));
  }
  ...
  public SELF containsExactly(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveIntArray(values)));
  }
  ...
  public SELF containsAnyOf(Integer[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveIntArray(values)));
  }
