...
//@format:on
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> iterables.assertNullOrEmpty(info, actual));
  }
  ...
  public SELF hasSize(int expected) {
    return runSoftly(() -> iterables.assertHasSize(info, actual, expected));
  }
  ...
  public SELF hasSizeGreaterThan(int boundary) {
    return runSoftly(() -> iterables.assertHasSizeGreaterThan(info, actual, boundary));
  }
  ...
  public SELF hasSizeGreaterThanOrEqualTo(int boundary) {
    return runSoftly(() -> iterables.assertHasSizeGreaterThanOrEqualTo(info, actual, boundary));
  }
  ...
  public SELF hasSizeLessThan(int boundary) {
    return runSoftly(() -> iterables.assertHasSizeLessThan(info, actual, boundary));
  }
  ...
  public SELF hasSizeLessThanOrEqualTo(int boundary) {
    return runSoftly(() -> iterables.assertHasSizeLessThanOrEqualTo(info, actual, boundary));
  }
  ...
  public SELF hasSizeBetween(int lowerBoundary, int higherBoundary) {
    return runSoftly(() -> iterables.assertHasSizeBetween(info, actual, lowerBoundary, higherBoundary));
  }

  @Override
  public SELF hasSameSizeAs(Object other) {
    return runSoftly(() -> iterables.assertHasSameSizeAs(info, actual, other));
  }
  ...
  protected SELF containsForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContains(info, actual, values));
  }
  ...
  protected SELF containsOnlyForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContainsOnly(info, actual, values));
  }
  ...
  protected SELF containsOnlyOnceForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContainsOnlyOnce(info, actual, values));
  }

  @Override
  public SELF containsOnlyNulls() {
    return runSoftly(() -> iterables.assertContainsOnlyNulls(info, actual));
  }
  ...
  protected SELF containsExactlyForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContainsExactly(info, actual, values));
  }
  ...
  protected SELF containsExactlyInAnyOrderForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContainsExactlyInAnyOrder(info, actual, values));
  }
  ...
  public SELF isSubsetOf(Iterable<? extends ELEMENT> values) {
    return runSoftly(() -> iterables.assertIsSubsetOf(info, actual, values));
  }
  ...
  protected SELF isSubsetOfForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertIsSubsetOf(info, actual, Arrays.asList(values)));
  }
  ...
  protected SELF containsSequenceForProxy(ELEMENT[] sequence) {
    return runSoftly(() -> iterables.assertContainsSequence(info, actual, sequence));
  }
  ...
  protected SELF doesNotContainSequenceForProxy(ELEMENT[] sequence) {
    return runSoftly(() -> iterables.assertDoesNotContainSequence(info, actual, sequence));
  }
  ...
  protected SELF containsSubsequenceForProxy(ELEMENT[] subsequence) {
    return runSoftly(() -> iterables.assertContainsSubsequence(info, actual, subsequence));
  }
  ...
  protected SELF doesNotContainSubsequenceForProxy(ELEMENT[] subsequence) {
    return runSoftly(() -> iterables.assertDoesNotContainSubsequence(info, actual, subsequence));
  }
  ...
  protected SELF doesNotContainForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertDoesNotContain(info, actual, values));
  }

  @Override
  public SELF doesNotContainAnyElementsOf(Iterable<? extends ELEMENT> iterable) {
    return runSoftly(() -> iterables.assertDoesNotContainAnyElementsOf(info, actual, iterable));
  }

  @Override
  public SELF doesNotHaveDuplicates() {
    return runSoftly(() -> iterables.assertDoesNotHaveDuplicates(info, actual));
  }
  ...
  protected SELF startsWithForProxy(ELEMENT[] sequence) {
    return runSoftly(() -> iterables.assertStartsWith(info, actual, sequence));
  }
  ...
  protected SELF endsWithForProxy(ELEMENT first, ELEMENT[] rest) {
    return runSoftly(() -> iterables.assertEndsWith(info, actual, first, rest));
  }

  @Override
  public SELF endsWith(ELEMENT[] sequence) {
    return runSoftly(() -> iterables.assertEndsWith(info, actual, sequence));
  }

  @Override
  public SELF containsNull() {
    return runSoftly(() -> iterables.assertContainsNull(info, actual));
  }

  @Override
  public SELF doesNotContainNull() {
    return runSoftly(() -> iterables.assertDoesNotContainNull(info, actual));
  }

  @Override
  public SELF are(Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertAre(info, actual, condition));
  }

  @Override
  public SELF areNot(Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertAreNot(info, actual, condition));
  }

  @Override
  public SELF have(Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertHave(info, actual, condition));
  }

  @Override
  public SELF doNotHave(Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertDoNotHave(info, actual, condition));
  }
  ...
  public SELF areAtLeast(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertAreAtLeast(info, actual, times, condition));
  }

  @Override
  public SELF areAtMost(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertAreAtMost(info, actual, times, condition));
  }

  @Override
  public SELF areExactly(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertAreExactly(info, actual, times, condition));
  }
  ...
  public SELF haveAtLeast(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertHaveAtLeast(info, actual, times, condition));
  }

  @Override
  public SELF haveAtMost(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertHaveAtMost(info, actual, times, condition));
  }

  @Override
  public SELF haveExactly(int times, Condition<? super ELEMENT> condition) {
    return runSoftly(() -> iterables.assertHaveExactly(info, actual, times, condition));
  }
  ...
  public SELF hasAtLeastOneElementOfType(Class<?> expectedType) {
    ...
    return runSoftly(() -> ObjectArrays.instance().assertHasAtLeastOneElementOfType(info, toArray(actual), expectedType));
  }
  ...
  public SELF hasOnlyElementsOfType(Class<?> expectedType) {
    // reuse code from object arrays as the logic is the same
    // (ok since this assertion doesn't rely on a comparison strategy)
    return runSoftly(() -> ObjectArrays.instance().assertHasOnlyElementsOfType(info, toArray(actual), expectedType));
  }
  ...
  public SELF doesNotHaveAnyElementsOfTypes(Class<?>... unexpectedTypes) {
    return runSoftly(() -> ObjectArrays.instance().assertDoesNotHaveAnyElementsOfTypes(info, toArray(actual), unexpectedTypes));
  }

  /** {@inheritDoc} */
  @Override
  public SELF hasOnlyElementsOfTypes(Class<?>... types) {
    return runSoftly(() -> ObjectArrays.instance().assertHasOnlyElementsOfTypes(info, toArray(actual), types));
  }

  /** {@inheritDoc} */
  @Override
  public SELF hasExactlyElementsOfTypes(Class<?>... types) {
    return runSoftly(() -> ObjectArrays.instance().assertHasExactlyElementsOfTypes(info, toArray(actual), types));
  }

  @Override
  public SELF containsAll(Iterable<? extends ELEMENT> iterable) {
    return runSoftly(() -> iterables.assertContainsAll(info, actual, iterable));
  }
  ...
  protected SELF containsAnyOfForProxy(ELEMENT[] values) {
    return runSoftly(() -> iterables.assertContainsAnyOf(info, actual, values));
  }
  ...
  public ELEMENT_ASSERT first() {
    return runSoftlyNavigation(() -> internalFirst());
  }
  ...
  public <ASSERT extends AbstractAssert<?, ?>> ASSERT first(InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    return runSoftlyNavigation(() -> internalFirst().asInstanceOf(assertFactory));
  }
  ...
  public ELEMENT_ASSERT last() {
    return runSoftlyNavigation(() -> internalLast());
  }
  ...
  public <ASSERT extends AbstractAssert<?, ?>> ASSERT last(InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    return runSoftlyNavigation(() -> internalLast().asInstanceOf(assertFactory));
  }
  ...
  public ELEMENT_ASSERT element(int index) {
    return runSoftlyNavigation(() -> internalElement(index));
  }
  ...
  public SELF elements(int... indices) {
    return (SELF) runSoftlyNavigation(() -> {
      isNotEmpty();
  ...
  public <ASSERT extends AbstractAssert<?, ?>> ASSERT element(int index, InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    return runSoftlyNavigation(() -> internalElement(index).asInstanceOf(assertFactory));
  }
  ...
  public ELEMENT_ASSERT singleElement() {
    return runSoftlyNavigation(() -> internalSingleElement());
  }
  ...
  public <ASSERT extends AbstractAssert<?, ?>> ASSERT singleElement(InstanceOfAssertFactory<?, ASSERT> assertFactory) {
    return runSoftlyNavigation(() -> internalSingleElement().asInstanceOf(assertFactory));
  }
  ...
  public SELF allMatch(Predicate<? super ELEMENT> predicate) {
    return runSoftly(() -> iterables.assertAllMatch(info, actual, predicate, PredicateDescription.GIVEN));
  }

  @Override
  public SELF allMatch(Predicate<? super ELEMENT> predicate, String predicateDescription) {
    return runSoftly(() -> iterables.assertAllMatch(info, actual, predicate, new PredicateDescription(predicateDescription)));
  }
  ...
  private SELF internalAllSatisfy(Consumer<? super ELEMENT> requirements) {
    return runSoftly(() -> iterables.assertAllSatisfy(info, actual, requirements));
  }

  @Override
  public SELF anyMatch(Predicate<? super ELEMENT> predicate) {
    return runSoftly(() -> iterables.assertAnyMatch(info, actual, predicate, PredicateDescription.GIVEN));
  }

  @Override
  public SELF anyMatch(Predicate<? super ELEMENT> predicate, String predicateDescription) {
    return runSoftly(() -> iterables.assertAnyMatch(info, actual, predicate, new PredicateDescription(predicateDescription)));
  }
  ...
  public <OTHER_ELEMENT> SELF zipSatisfy(Iterable<OTHER_ELEMENT> other,
    ...
    return runSoftly(() -> iterables.assertZipSatisfy(info, actual, other, zipRequirements));
  }
  ...
  private SELF internalAnySatisfy(Consumer<? super ELEMENT> requirements) {
    return runSoftly(() -> iterables.assertAnySatisfy(info, actual, requirements));
  }
  ...
  private SELF internalNoneSatisfy(Consumer<? super ELEMENT> restrictions) {
    return runSoftly(() -> iterables.assertNoneSatisfy(info, actual, restrictions));
  }
  ...
  protected SELF satisfiesExactlyForProxy(Consumer<? super ELEMENT>[] requirements) {
    return runSoftly(() -> iterables.assertSatisfiesExactly(info, actual, requirements));
  }
  ...
  protected SELF satisfiesExactlyInAnyOrderForProxy(Consumer<? super ELEMENT>[] requirements) {
    return runSoftly(() -> iterables.assertSatisfiesExactlyInAnyOrder(info, actual, requirements));
  }
  ...
  protected SELF satisfiesOnlyOnceForProxy(Consumer<? super ELEMENT> requirements) {
    return runSoftly(() -> iterables.assertSatisfiesOnlyOnce(info, actual, requirements));
  }
  ...
  public SELF noneMatch(Predicate<? super ELEMENT> predicate) {
    return runSoftly(() -> iterables.assertNoneMatch(info, actual, predicate, PredicateDescription.GIVEN));
  }

  @Override
  public SELF noneMatch(Predicate<? super ELEMENT> predicate, String predicateDescription) {
    return runSoftly(() -> iterables.assertNoneMatch(info, actual, predicate, new PredicateDescription(predicateDescription)));
  }
