...
// @format:on
  ...
  public SELF contains(ELEMENT value, Index index) {
    return runSoftly(() -> lists.assertContains(info, actual, value, index));
  }

  /** {@inheritDoc} */
  @Override
  public SELF doesNotContain(ELEMENT value, Index index) {
    return runSoftly(() -> lists.assertDoesNotContain(info, actual, value, index));
  }
  ...
  public SELF has(Condition<? super ELEMENT> condition, Index index) {
    return runSoftly(() -> lists.assertHas(info, actual, condition, index));
  }
  ...
  public SELF is(Condition<? super ELEMENT> condition, Index index) {
    return runSoftly(() -> lists.assertIs(info, actual, condition, index));
  }
  ...
  public SELF isSorted() {
    return runSoftly(() -> lists.assertIsSorted(info, actual));
  }
  ...
  public SELF isSortedAccordingTo(Comparator<? super ELEMENT> comparator) {
    return runSoftly(() -> lists.assertIsSortedAccordingToComparator(info, actual, comparator));
  }
  ...
  public SELF satisfies(Consumer<? super ELEMENT> requirements, Index index) {
    return runSoftly(() -> lists.satisfies(info, actual, requirements, index));
  }
