...
public abstract class AbstractLongArrayAssert<SELF extends AbstractLongArrayAssert<SELF>>
  ...
  public SELF contains(Long[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF containsOnly(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF containsSequence(Long[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveLongArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Long[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveLongArray(subsequence)));
  }
  ...
  public SELF doesNotContain(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF startsWith(Long[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveLongArray(sequence)));
  }
  ...
  public SELF endsWith(Long[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveLongArray(sequence)));
  }
  ...
  public SELF containsExactly(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveLongArray(values)));
  }
  ...
  public SELF containsAnyOf(Long[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveLongArray(values)));
  }
