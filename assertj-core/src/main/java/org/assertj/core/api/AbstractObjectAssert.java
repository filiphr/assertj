...
public abstract class AbstractObjectAssert<SELF extends AbstractObjectAssert<SELF, ACTUAL>, ACTUAL>
  ...
  public SELF hasNoNullFieldsOrProperties() {
    return runSoftly(() -> objects.assertHasNoNullFieldsOrPropertiesExcept(info, actual));
  }
  ...
  public SELF hasAllNullFieldsOrProperties() {
    return runSoftly(() -> objects.assertHasAllNullFieldsOrPropertiesExcept(info, actual));
  }
  ...
  public SELF hasNoNullFieldsOrPropertiesExcept(String... propertiesOrFieldsToIgnore) {
    return runSoftly(() -> objects.assertHasNoNullFieldsOrPropertiesExcept(info, actual, propertiesOrFieldsToIgnore));
  }
  ...
  public SELF hasAllNullFieldsOrPropertiesExcept(String... propertiesOrFieldsToIgnore) {
    return runSoftly(() -> objects.assertHasAllNullFieldsOrPropertiesExcept(info, actual, propertiesOrFieldsToIgnore));
  }
  ...
  public SELF hasFieldOrProperty(String name) {
    return runSoftly(() -> objects.assertHasFieldOrProperty(info, actual, name));
  }
  ...
  public SELF hasFieldOrPropertyWithValue(String name, Object value) {
    return runSoftly(() -> objects.assertHasFieldOrPropertyWithValue(info, actual, name, value));
  }
  ...
  public SELF hasOnlyFields(String... expectedFieldNames) {
    return runSoftly(() -> objects.assertHasOnlyFields(info, actual, expectedFieldNames));
  }
