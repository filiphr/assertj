...
public abstract class AbstractOffsetDateTimeAssert<SELF extends AbstractOffsetDateTimeAssert<SELF>> extends
  ...
  public SELF isBefore(OffsetDateTime other) {
    ...
    return runSoftly(() -> comparables.assertIsBefore(info, actual, other));
  }
  ...
  public SELF isBeforeOrEqualTo(OffsetDateTime other) {
    assertOffsetDateTimeParameterIsNotNull(other);
    return runSoftly(() -> comparables.assertIsBeforeOrEqualTo(info, actual, other));
  }
  ...
  public SELF isAfterOrEqualTo(OffsetDateTime other) {
    assertOffsetDateTimeParameterIsNotNull(other);
    return runSoftly(() -> comparables.assertIsAfterOrEqualTo(info, actual, other));
  }
  ...
  public SELF isAfter(OffsetDateTime other) {
    assertOffsetDateTimeParameterIsNotNull(other);
    return runSoftly(() -> comparables.assertIsAfter(info, actual, other));
  }
   ...
   * which must follow <a href="https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html#ISO_OFFSET_DATE_TIME">ISO OffsetDateTime format</a>
