...
public abstract class AbstractPathAssert<SELF extends AbstractPathAssert<SELF>> extends AbstractComparableAssert<SELF, Path> {
  ...
  public SELF hasSameTextualContentAs(Path expected) {
    return runSoftly(() -> paths.assertHasSameTextualContentAs(info, actual, charset, expected, Charset.defaultCharset()));
  }
  ...
  public SELF hasSameTextualContentAs(Path expected, Charset expectedCharset) {
    return runSoftly(() -> paths.assertHasSameTextualContentAs(info, actual, charset, expected, expectedCharset));
  }
  ...
  public SELF hasBinaryContent(byte[] expected) {
    return runSoftly(() -> paths.assertHasBinaryContent(info, actual, expected));
  }
  ...
  public SELF hasSameBinaryContentAs(Path expected) {
    return runSoftly(() -> paths.assertHasSameBinaryContentAs(info, actual, expected));
  }
  ...
  public SELF hasContent(String expected) {
    return runSoftly(() -> paths.assertHasTextualContent(info, actual, expected, charset));
  }
  ...
  public SELF hasFileSystem(FileSystem expected) {
    return runSoftly(() -> paths.assertHasFileSystem(info, actual, expected));
  }
  ...
  public SELF hasSameFileSystemAs(Path expected) {
    return runSoftly(() -> paths.assertHasSameFileSystemAs(info, actual, expected));
  }
  ...
  public SELF isReadable() {
    return runSoftly(() -> paths.assertIsReadable(info, actual));
  }
  ...
  public SELF isWritable() {
    return runSoftly(() -> paths.assertIsWritable(info, actual));
  }
  ...
  public SELF isExecutable() {
    return runSoftly(() -> paths.assertIsExecutable(info, actual));
  }
   ...
   */
  public SELF exists() {
    return runSoftly(() -> paths.assertExists(info, actual));
  }
  ...
  public SELF existsNoFollowLinks() {
    return runSoftly(() -> paths.assertExistsNoFollowLinks(info, actual));
  }
  ...
  public SELF doesNotExist() {
    return runSoftly(() -> paths.assertDoesNotExist(info, actual));
  }
  ...
  public SELF isRegularFile() {
    return runSoftly(() -> paths.assertIsRegularFile(info, actual));
  }
  ...
  public SELF isDirectory() {
    return runSoftly(() -> paths.assertIsDirectory(info, actual));
  }
  ...
  public SELF isSymbolicLink() {
    return runSoftly(() -> paths.assertIsSymbolicLink(info, actual));
  }
  ...
  public SELF isAbsolute() {
    return runSoftly(() -> paths.assertIsAbsolute(info, actual));
  }
  ...
  public SELF isRelative() {
    return runSoftly(() -> paths.assertIsRelative(info, actual));
  }
  ...
  public SELF isNormalized() {
    return runSoftly(() -> paths.assertIsNormalized(info, actual));
  }
  ...
  public SELF isCanonical() {
    return runSoftly(() -> paths.assertIsCanonical(info, actual));
  }
  ...
  public SELF hasFileName(final String fileName) {
    return runSoftly(() -> paths.assertHasFileName(info, actual, fileName));
  }
  ...
  public SELF hasParent(final Path expected) {
    return runSoftly(() -> paths.assertHasParent(info, actual, expected));
  }
  ...
  public SELF hasParentRaw(final Path expected) {
    return runSoftly(() -> paths.assertHasParentRaw(info, actual, expected));
  }
  ...
  public SELF hasNoParent() {
    return runSoftly(() -> paths.assertHasNoParent(info, actual));
  }
  ...
  public SELF hasNoParentRaw() {
    return runSoftly(() -> paths.assertHasNoParentRaw(info, actual));
  }
  ...
  public SELF hasSize(long expectedSize) {
    return runSoftly(() -> paths.assertHasSize(info, actual, expectedSize));
  }
  ...
  public SELF startsWith(final Path other) {
    return runSoftly(() -> paths.assertStartsWith(info, actual, other));
  }
  ...
  public SELF startsWithRaw(final Path other) {
    return runSoftly(() -> paths.assertStartsWithRaw(info, actual, other));
  }
  ...
  public SELF endsWith(final Path other) {
    return runSoftly(() -> paths.assertEndsWith(info, actual, other));
  }
  ...
  public SELF endsWithRaw(final Path other) {
    return runSoftly(() -> paths.assertEndsWithRaw(info, actual, other));
  }
  ...
  public SELF hasDigest(MessageDigest digest, byte[] expected) {
    return runSoftly(() -> paths.assertHasDigest(info, actual, digest, expected));
  }
  ...
  public SELF hasDigest(String algorithm, byte[] expected) {
    return runSoftly(() -> paths.assertHasDigest(info, actual, algorithm, expected));
  }
  ...
  public SELF isDirectoryContaining(Predicate<Path> filter) {
    return runSoftly(() -> paths.assertIsDirectoryContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryContaining(String syntaxAndPattern) {
    return runSoftly(() -> paths.assertIsDirectoryContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isDirectoryRecursivelyContaining(String syntaxAndPattern) {
    return runSoftly(() -> paths.assertIsDirectoryRecursivelyContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isDirectoryRecursivelyContaining(Predicate<Path> filter) {
    return runSoftly(() -> paths.assertIsDirectoryRecursivelyContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryNotContaining(Predicate<Path> filter) {
    return runSoftly(() -> paths.assertIsDirectoryNotContaining(info, actual, filter));
  }
  ...
  public SELF isDirectoryNotContaining(String syntaxAndPattern) {
    return runSoftly(() -> paths.assertIsDirectoryNotContaining(info, actual, syntaxAndPattern));
  }
  ...
  public SELF isEmptyDirectory() {
    return runSoftly(() -> paths.assertIsEmptyDirectory(info, actual));
  }
  ...
  public SELF isNotEmptyDirectory() {
    return runSoftly(() -> paths.assertIsNotEmptyDirectory(info, actual));
  }
  ...
  public SELF isEmptyFile() {
    return runSoftly(() -> paths.assertIsEmptyFile(info, actual));
  }
  ...
  public SELF isNotEmptyFile() {
    return runSoftly(() -> paths.assertIsNotEmptyFile(info, actual));
  }
  ...
  public SELF hasExtension(String expectedExtension) {
    return runSoftly(() -> paths.assertHasExtension(info, actual, expectedExtension));
  }
  ...
  public SELF hasNoExtension() {
    return runSoftly(() -> paths.assertHasNoExtension(info, actual));
  }
