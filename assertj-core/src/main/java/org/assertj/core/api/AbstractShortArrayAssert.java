...
public abstract class AbstractShortArrayAssert<SELF extends AbstractShortArrayAssert<SELF>>
  ...
  public SELF contains(Short[] values) {
    ...
    return runSoftly(() -> arrays.assertContains(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF contains(int... values) {
    return runSoftly(() -> arrays.assertContains(info, actual, toShortArray(values)));
  }
  ...
  public SELF containsOnly(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF containsOnly(int... values) {
    return runSoftly(() -> arrays.assertContainsOnly(info, actual, toShortArray(values)));
  }
  ...
  public SELF containsOnlyOnce(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF containsOnlyOnce(int... values) {
    return runSoftly(() -> arrays.assertContainsOnlyOnce(info, actual, toShortArray(values)));
  }
  ...
  public SELF containsSequence(Short[] sequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toPrimitiveShortArray(sequence)));
  }
  ...
  public SELF containsSequence(int... sequence) {
    return runSoftly(() -> arrays.assertContainsSequence(info, actual, toShortArray(sequence)));
  }
  ...
  public SELF containsSubsequence(Short[] subsequence) {
    ...
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toPrimitiveShortArray(subsequence)));
  }
  ...
  public SELF containsSubsequence(int... subsequence) {
    return runSoftly(() -> arrays.assertContainsSubsequence(info, actual, toShortArray(subsequence)));
  }
  ...
  public SELF contains(int value, Index index) {
    return runSoftly(() -> arrays.assertContains(info, actual, toShort(value), index));
  }
  ...
  public SELF doesNotContain(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF doesNotContain(int... values) {
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toShortArray(values)));
  }
  ...
  public SELF doesNotContain(int value, Index index) {
    return runSoftly(() -> arrays.assertDoesNotContain(info, actual, toShort(value), index));
  }
  ...
  public SELF startsWith(Short[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toPrimitiveShortArray(sequence)));
  }
  ...
  public SELF startsWith(int... sequence) {
    return runSoftly(() -> arrays.assertStartsWith(info, actual, toShortArray(sequence)));
  }
  ...
  public SELF endsWith(Short[] sequence) {
    requireNonNullParameter(sequence, "sequence");
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toPrimitiveShortArray(sequence)));
  }
  ...
  public SELF endsWith(int... sequence) {
    return runSoftly(() -> arrays.assertEndsWith(info, actual, toShortArray(sequence)));
  }
  ...
  public SELF containsExactly(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF containsExactly(int... values) {
    return runSoftly(() -> arrays.assertContainsExactly(info, actual, toShortArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF containsExactlyInAnyOrder(int... values) {
    return runSoftly(() -> arrays.assertContainsExactlyInAnyOrder(info, actual, toShortArray(values)));
  }
  ...
  public SELF containsAnyOf(Short[] values) {
    requireNonNullParameter(values, "values");
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toPrimitiveShortArray(values)));
  }
  ...
  public SELF containsAnyOf(int... values) {
    return runSoftly(() -> arrays.assertContainsAnyOf(info, actual, toShortArray(values)));
  }
