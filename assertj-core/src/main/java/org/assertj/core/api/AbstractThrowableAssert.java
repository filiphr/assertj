...
public abstract class AbstractThrowableAssert<SELF extends AbstractThrowableAssert<SELF, ACTUAL>, ACTUAL extends Throwable>
  ...
  public SELF hasMessage(String message) {
    return runSoftly(() -> throwables.assertHasMessage(info, actual, message));
  }
  ...
  public SELF hasCause(Throwable cause) {
    return runSoftly(() -> throwables.assertHasCause(info, actual, cause));
  }
  ...
  public SELF hasNoCause() {
    return runSoftly(() -> throwables.assertHasNoCause(info, actual));
  }
  ...
  public SELF hasMessageStartingWith(String description) {
    return runSoftly(() -> throwables.assertHasMessageStartingWith(info, actual, description));
  }
  ...
  public SELF hasMessageStartingWith(String description, Object... parameters) {
    return runSoftly(() -> throwables.assertHasMessageStartingWith(info, actual, description.formatted(parameters)));
  }
  ...
  public SELF hasMessageContaining(String description) {
    return runSoftly(() -> throwables.assertHasMessageContaining(info, actual, description));
  }
  ...
  public SELF hasMessageContainingAll(CharSequence... values) {
    return runSoftly(() -> throwables.assertHasMessageContainingAll(info, actual, values));
  }
  ...
  public SELF hasMessageNotContaining(String content) {
    return runSoftly(() -> throwables.assertHasMessageNotContaining(info, actual, content));
  }
  ...
  public SELF hasMessageNotContainingAny(CharSequence... values) {
    return runSoftly(() -> throwables.assertHasMessageNotContainingAny(info, actual, values));
  }
  ...
  public SELF hasStackTraceContaining(String description) {
    return runSoftly(() -> throwables.assertHasStackTraceContaining(info, actual, description));
  }
  ...
  public SELF hasStackTraceContaining(String description, Object... parameters) {
    return runSoftly(() -> throwables.assertHasStackTraceContaining(info, actual, description.formatted(parameters)));
  }
  ...
  public SELF hasMessageMatching(String regex) {
    return runSoftly(() -> throwables.assertHasMessageMatching(info, actual, regex));
  }
  ...
  public SELF hasMessageFindingMatch(String regex) {
    return runSoftly(() -> throwables.assertHasMessageFindingMatch(info, actual, regex));
  }
  ...
  public SELF hasMessageEndingWith(String description) {
    return runSoftly(() -> throwables.assertHasMessageEndingWith(info, actual, description));
  }
  ...
  public SELF hasMessageEndingWith(String description, Object... parameters) {
    return runSoftly(() -> throwables.assertHasMessageEndingWith(info, actual, description.formatted(parameters)));
  }
  ...
  public SELF hasCauseInstanceOf(Class<? extends Throwable> type) {
    return runSoftly(() -> throwables.assertHasCauseInstanceOf(info, actual, type));
  }
  ...
  public SELF hasCauseExactlyInstanceOf(Class<? extends Throwable> type) {
    return runSoftly(() -> throwables.assertHasCauseExactlyInstanceOf(info, actual, type));
  }
  ...
  public SELF hasRootCause(Throwable cause) {
    return runSoftly(() -> throwables.assertHasRootCause(info, actual, cause));
  }
  ...
  public SELF hasRootCauseInstanceOf(Class<? extends Throwable> type) {
    return runSoftly(() -> throwables.assertHasRootCauseInstanceOf(info, actual, type));
  }
  ...
  public SELF hasRootCauseExactlyInstanceOf(Class<? extends Throwable> type) {
    return runSoftly(() -> throwables.assertHasRootCauseExactlyInstanceOf(info, actual, type));
  }
  ...
  public SELF hasRootCauseMessage(String message) {
    return runSoftly(() -> throwables.assertHasRootCauseMessage(info, actual, message));
  }
  ...
  public SELF hasNoSuppressedExceptions() {
    return runSoftly(() -> throwables.assertHasNoSuppressedExceptions(info, actual));
  }
  ...
  public SELF hasSuppressedException(Throwable suppressedException) {
    return runSoftly(() -> throwables.assertHasSuppressedException(info, actual, suppressedException));
  }
