...
public abstract class AbstractUriAssert<SELF extends AbstractUriAssert<SELF>> extends AbstractComparableAssert<SELF, URI> {
  ...
  public SELF hasPath(String expected) {
    return runSoftly(() -> uris.assertHasPath(info, actual, expected));
  }
  ...
  public SELF hasNoPath() {
    return runSoftly(() -> uris.assertHasPath(info, actual, null));
  }
  ...
  public SELF hasPort(int expected) {
    return runSoftly(() -> uris.assertHasPort(info, actual, expected));
  }
  ...
  public SELF hasNoPort() {
    return runSoftly(() -> uris.assertHasPort(info, actual, -1));
  }
  ...
  public SELF hasHost(String expected) {
    return runSoftly(() -> uris.assertHasHost(info, actual, expected));
  }
  ...
  public SELF hasNoHost() {
    return runSoftly(() -> uris.assertHasNoHost(info, actual));
  }
  ...
  public SELF hasAuthority(String expected) {
    return runSoftly(() -> uris.assertHasAuthority(info, actual, expected));
  }
  ...
  public SELF hasFragment(String expected) {
    return runSoftly(() -> uris.assertHasFragment(info, actual, expected));
  }
  ...
  public SELF hasNoFragment() {
    return runSoftly(() -> uris.assertHasFragment(info, actual, null));
  }
  ...
  public SELF hasQuery(String expected) {
    return runSoftly(() -> uris.assertHasQuery(info, actual, expected));
  }
  ...
  public SELF hasNoQuery() {
    return runSoftly(() -> uris.assertHasQuery(info, actual, null));
  }
  ...
  public SELF hasScheme(String expected) {
    return runSoftly(() -> uris.assertHasScheme(info, actual, expected));
  }
  ...
  public SELF hasUserInfo(String expected) {
    return runSoftly(() -> uris.assertHasUserInfo(info, actual, expected));
  }
  ...
  public SELF hasNoUserInfo() {
    return runSoftly(() -> uris.assertHasUserInfo(info, actual, null));
  }
  ...
  public SELF hasParameter(String name) {
    return runSoftly(() -> uris.assertHasParameter(info, actual, name));
  }
  ...
  public SELF hasParameter(String name, String value) {
    return runSoftly(() -> uris.assertHasParameter(info, actual, name, value));
  }
  ...
  public SELF hasNoParameters() {
    return runSoftly(() -> uris.assertHasNoParameters(info, actual));
  }
  ...
  public SELF hasNoParameter(String name) {
    return runSoftly(() -> uris.assertHasNoParameter(info, actual, name));
  }
  ...
  public SELF hasNoParameter(String name, String value) {
    return runSoftly(() -> uris.assertHasNoParameter(info, actual, name, value));
  }
}
