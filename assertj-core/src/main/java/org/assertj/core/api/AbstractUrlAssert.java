...
public abstract class AbstractUrlAssert<SELF extends AbstractUrlAssert<SELF>> extends AbstractAssertWithComparator<SELF, URL> {
  ...
  public SELF hasProtocol(String expected) {
    return runSoftly(() -> urls.assertHasProtocol(info, actual, expected));
  }
  ...
  public SELF hasPath(String expected) {
    return runSoftly(() -> urls.assertHasPath(info, actual, expected));
  }
  ...
  public SELF hasNoPath() {
    return runSoftly(() -> urls.assertHasPath(info, actual, ""));
  }
  ...
  public SELF hasPort(int expected) {
    return runSoftly(() -> urls.assertHasPort(info, actual, expected));
  }
  ...
  public SELF hasNoPort() {
    return runSoftly(() -> urls.assertHasPort(info, actual, -1));
  }
  ...
  public SELF hasHost(String expected) {
    return runSoftly(() -> urls.assertHasHost(info, actual, expected));
  }
  ...
  public SELF hasNoHost() {
    return runSoftly(() -> urls.assertHasNoHost(info, actual));
  }
  ...
  public SELF hasAuthority(String expected) {
    return runSoftly(() -> urls.assertHasAuthority(info, actual, expected));
  }
  ...
  public SELF hasQuery(String expected) {
    return runSoftly(() -> urls.assertHasQuery(info, actual, expected));
  }
  ...
  public SELF hasNoQuery() {
    return runSoftly(() -> urls.assertHasQuery(info, actual, null));
  }
  ...
  public SELF hasAnchor(String expected) {
    return runSoftly(() -> urls.assertHasAnchor(info, actual, expected));
  }
  ...
  public SELF hasNoAnchor() {
    return runSoftly(() -> urls.assertHasAnchor(info, actual, null));
  }
  ...
  public SELF hasUserInfo(String expected) {
    return runSoftly(() -> urls.assertHasUserInfo(info, actual, expected));
  }
  ...
  public SELF hasNoUserInfo() {
    return runSoftly(() -> urls.assertHasUserInfo(info, actual, null));
  }
  ...
  public SELF hasParameter(String name) {
    return runSoftly(() -> urls.assertHasParameter(info, actual, name));
  }
  ...
  public SELF hasParameter(String name, String value) {
    return runSoftly(() -> urls.assertHasParameter(info, actual, name, value));
  }
  ...
  public SELF hasNoParameters() {
    return runSoftly(() -> urls.assertHasNoParameters(info, actual));
  }
  ...
  public SELF hasNoParameter(String name) {
    return runSoftly(() -> urls.assertHasNoParameter(info, actual, name));
  }
  ...
  public SELF hasNoParameter(String name, String value) {
    return runSoftly(() -> urls.assertHasNoParameter(info, actual, name, value));
  }
  ...
  public SELF isEqualToWithSortedQueryParameters(URL expected) {
    return runSoftly(() -> urls.assertIsEqualToWithSortedQueryParameters(info, actual, expected));
  }
}
