...
public class Boolean2DArrayAssert extends Abstract2DArrayAssert<Boolean2DArrayAssert, boolean[][], Boolean> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> boolean2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> boolean2dArrays.assertEmpty(info, actual));
  }
  ...
  public Boolean2DArrayAssert isNotEmpty() {
    return runSoftly(() -> boolean2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Boolean2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> boolean2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Boolean2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> boolean2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Boolean2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> boolean2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Boolean2DArrayAssert contains(boolean[] value, Index index) {
    return runSoftly(() -> boolean2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Boolean2DArrayAssert doesNotContain(boolean[] value, Index index) {
    return runSoftly(() -> boolean2dArrays.assertDoesNotContain(info, actual, value, index));
  }
}
