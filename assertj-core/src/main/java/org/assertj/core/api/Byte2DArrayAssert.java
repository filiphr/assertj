...
public class Byte2DArrayAssert extends Abstract2DArrayAssert<Byte2DArrayAssert, byte[][], Byte> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> byte2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> byte2dArrays.assertEmpty(info, actual));
  }
  ...
  public Byte2DArrayAssert isNotEmpty() {
    return runSoftly(() -> byte2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Byte2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> byte2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Byte2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> byte2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Byte2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> byte2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Byte2DArrayAssert contains(byte[] value, Index index) {
    return runSoftly(() -> byte2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Byte2DArrayAssert doesNotContain(byte[] value, Index index) {
    return runSoftly(() -> byte2dArrays.assertDoesNotContain(info, actual, value, index));
  }
}
