...
public class Char2DArrayAssert extends Abstract2DArrayAssert<Char2DArrayAssert, char[][], Character> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> char2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> char2dArrays.assertEmpty(info, actual));
  }
  ...
  public Char2DArrayAssert isNotEmpty() {
    return runSoftly(() -> char2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Char2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> char2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Char2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> char2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Char2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> char2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Char2DArrayAssert contains(char[] value, Index index) {
    return runSoftly(() -> char2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Char2DArrayAssert doesNotContain(char[] value, Index index) {
    return runSoftly(() -> char2dArrays.assertDoesNotContain(info, actual, value, index));
  }
