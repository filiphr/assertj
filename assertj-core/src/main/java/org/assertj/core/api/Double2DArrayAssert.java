...
public class Double2DArrayAssert extends Abstract2DArrayAssert<Double2DArrayAssert, double[][], Double> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> double2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> double2dArrays.assertEmpty(info, actual));
  }
  ...
  public Double2DArrayAssert isNotEmpty() {
    return runSoftly(() -> double2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Double2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> double2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Double2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> double2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Double2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> double2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Double2DArrayAssert contains(double[] value, Index index) {
    return runSoftly(() -> double2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Double2DArrayAssert doesNotContain(double[] value, Index index) {
    return runSoftly(() -> double2dArrays.assertDoesNotContain(info, actual, value, index));
  }
}
