...
public class Float2DArrayAssert extends Abstract2DArrayAssert<Float2DArrayAssert, float[][], Float> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> float2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> float2dArrays.assertEmpty(info, actual));
  }
  ...
  public Float2DArrayAssert isNotEmpty() {
    return runSoftly(() -> float2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Float2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> float2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Float2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> float2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Float2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> float2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Float2DArrayAssert contains(float[] value, Index index) {
    return runSoftly(() -> float2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Float2DArrayAssert doesNotContain(float[] value, Index index) {
    return runSoftly(() -> float2dArrays.assertDoesNotContain(info, actual, value, index));
  }
