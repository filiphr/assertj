...
public class Long2DArrayAssert extends Abstract2DArrayAssert<Long2DArrayAssert, long[][], Long> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> long2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> long2dArrays.assertEmpty(info, actual));
  }
  ...
  public Long2DArrayAssert isNotEmpty() {
    return runSoftly(() -> long2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Long2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> long2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Long2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> long2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Long2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> long2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Long2DArrayAssert contains(long[] value, Index index) {
    return runSoftly(() -> long2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Long2DArrayAssert doesNotContain(long[] value, Index index) {
    return runSoftly(() -> long2dArrays.assertDoesNotContain(info, actual, value, index));
  }
}
