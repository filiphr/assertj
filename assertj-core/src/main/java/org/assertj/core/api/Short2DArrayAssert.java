...
public class Short2DArrayAssert extends Abstract2DArrayAssert<Short2DArrayAssert, short[][], Short> {
  ...
  public void isNullOrEmpty() {
    runSoftlyVoid(() -> short2dArrays.assertNullOrEmpty(info, actual));
  }
  ...
  @Override
  public void isEmpty() {
    runSoftlyVoid(() -> short2dArrays.assertEmpty(info, actual));
  }
  ...
  public Short2DArrayAssert isNotEmpty() {
    return runSoftly(() -> short2dArrays.assertNotEmpty(info, actual));
  }
  ...
  public Short2DArrayAssert hasDimensions(int expectedFirstDimension, int expectedSecondDimension) {
    return runSoftly(() -> short2dArrays.assertHasDimensions(info, actual, expectedFirstDimension, expectedSecondDimension));
  }
  ...
  public Short2DArrayAssert hasNumberOfRows(int expected) {
    return runSoftly(() -> short2dArrays.assertNumberOfRows(info, actual, expected));
  }
  ...
  public Short2DArrayAssert hasSameDimensionsAs(Object array) {
    return runSoftly(() -> short2dArrays.assertHasSameDimensionsAs(info, actual, array));
  }
  ...
  public Short2DArrayAssert contains(short[] value, Index index) {
    return runSoftly(() -> short2dArrays.assertContains(info, actual, value, index));
  }
  ...
  public Short2DArrayAssert contains(int[] value, Index index) {
    return runSoftly(() -> short2dArrays.assertContains(info, actual, toShort(value), index));
  }
  ...
  public Short2DArrayAssert doesNotContain(short[] value, Index index) {
    return runSoftly(() -> short2dArrays.assertDoesNotContain(info, actual, value, index));
  }
  ...
  public Short2DArrayAssert doesNotContain(int[] value, Index index) {
    return runSoftly(() -> short2dArrays.assertDoesNotContain(info, actual, toShort(value), index));
  }
